                    ...
                    <div className="col-12 text-center">
                        <div className='py-5 px-2'>
                            {lang == 'en' ? <>
                                ...
                                <h2 className='mb-5'>مؤسسة أمان فوود التجارية </h2>
                                <p> .تقع مؤسسة أمان فوود التجارية في منطقة القصيم بقلب المملكة العربية السعودية. اكتسب فريقنا على مدى سنوات من الخبرة في مجال التجارة الدولية والاستيراد والتصدير على الإمدادات الغذائية في السلع الاستهلاكية سريعة الحركة والمواد المجمدة والمخللات والمكسرات والحبوب والتمور وحبوب البن الخام من أصول مختلفة. نحن نتعاقد مباشرة مع أكبر شركات المزارعين والمنتجين والتجار الموجودة في جميع أنحاء العالم. لدينا مجموعة كبيرة ومتنوعة من المنتجات التي تم اختيارها بعناية على أساس الجودة وبأسعار تنافسية</p>
                            </>}
                        </div>
                    </div>
                </div>
